...
WXYCDJ/                          # App target sources
  ...
  Bin/                           # BinView + VM
  Telemetry/                     # error reporting (#106): ErrorReporter seam, privacy scrub,
                                 #   build environment, Sentry bootstrap (the one Sentry import)
...
- PostHog product analytics ([#108](https://github.com/WXYC/wxyc-dj-ios/issues/108)), extending the same privacy contract. Sentry error reporting is **no longer deferred** — it shipped in [#106](https://github.com/WXYC/wxyc-dj-ios/issues/106); see [`docs/adr/0007-ios-anonymous-error-reporting.md`](docs/adr/0007-ios-anonymous-error-reporting.md) for what is and isn't collected, and [#107](https://github.com/WXYC/wxyc-dj-ios/issues/107) for the dSYM upload that makes Release stack traces symbolicate
